...
>
> **Sources:**
> 1. Pavol Luptak (Nethemba) — [How to Survive on Crypto in 2025 as a Digital Nomad](https://slides.com/nethemba/how-to-survive-on-crypto-in-2025-as-a-digital-nomad)
> 2. David Stancel — [davidstancel.com/crypto](https://davidstancel.com/crypto)

**Legend:**
- ✅ = Already on Polystate toolkit
- 🆕 = Not yet on Polystate
- `[L]` = Luptak only | `[D]` = davidstancel.com only | `[both]` = on both lists
...
| # | Coin | Use Case | Source |
|---|------|----------|--------|
| 1 | Monero (XMR) | Maximum privacy, anonymous payments | [L] |
| 2 | ZCash (ZEC) | Privacy with shielded transactions | [both] |
| 3 | Bitcoin (BTC) | Base layer, store of value | [both] |
| 4 | Bitcoin Lightning | Fast payments, improved privacy over base BTC | [L] |
| 5 | Cashu | Chaumian e-cash, mint-based privacy | [L] |
| 6 | Ethereum (ETH) | Smart contracts, DeFi | [both] |
| 7 | Solana (SOL) | Referenced in Atomic Exchange swaps | [D] |
| 8 | DAI | Decentralized stablecoin | [L] |
| 9 | LUSD | Decentralized stablecoin (Liquity) | [L] |
| 10 | USDT | Centralized stablecoin | [both] |
| 11 | USDC | Centralized stablecoin | [both] |

---

## Key Strategies (from Luptak)
...
7. **Author's personal setup**: Paraguay + Panama + Uruguay residencies, Bank of Georgia, multiple crypto stacks
...
| From Luptak only `[L]` | 56 |
| From davidstancel.com only `[D]` | 14 |
| On both lists `[both]` | 7 |
